...
Imports SGConsoleApp.Settings
Public Class Email
    Private Email As SGConsoleApp.Settings.Email
    Public Sub New(settings As SGConsoleApp.Settings.Email)
    ...
    Public Function sendEmail(addressList As String, subject As String, messageContent As String) As String
        Try
            ...
            'message.Sender.Address = Email.SenderAddress
